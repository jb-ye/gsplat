...
inline __device__ void cov2d_to_compensation_vjp(
    ...
    float d_f_d_sqr_comp = v_compensation * 0.5 / (compensation + 0.00001);
    v_cov2d.x += d_f_d_sqr_comp * (one_minus_sqr_comp * conic.x - 0.3 * inv_det);
    v_cov2d.y += 2 * d_f_d_sqr_comp * (one_minus_sqr_comp * conic.y);
    v_cov2d.z += d_f_d_sqr_comp * (one_minus_sqr_comp * conic.z - 0.3 * inv_det);
}
